...
list_path = os.path.join(base, 'grid1_list.txt')
# Fixed params
...
ara_step = 0.2
ara_max_iter = 3
z_vals = [0.05, 0.10, 0.15]
los_vals = [0.06, 0.08, 0.10]
time_global_vals = [0.90, 0.92, 0.94, 0.96, 0.98]
path_simplify_scale = 1.0
shortcut_passes = 1
names = []
for z_penalty, los_step, t_global in itertools.product(z_vals, los_vals, time_global_vals):
    name = f"variant_G1_z{int(z_penalty*100):02d}_l{int(los_step*100):02d}_t{int(t_global*100):02d}"
